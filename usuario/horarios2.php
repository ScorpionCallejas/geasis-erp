        ...
        <div class="main-card mb-3 card" >
            <div class="card-body">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a data-toggle="tab" href="#tab-eg10-0" class="active nav-link letraPequena">Todos los grupos</a>
                    </li>
                    
                    <li class="nav-item">
                        <a data-toggle="tab" href="#tab-eg10-1" class="nav-link letraPequena">Grupos fusionados</a>
                    </li>

                    <li class="nav-item">
                        <a data-toggle="tab" href="#tab-eg10-2" class="nav-link letraPequena" id="btn_fusion_grupal_nueva">Fusión grupal nueva</a>
                    </li>

                    <li class="nav-item">
                        <a data-toggle="tab" href="#tab-eg10-3" class="nav-link letraPequena" id="btn_fusion_grupal_iniciados">Fusión grupal iniciados</a>
                    </li>


                    <li class="nav-item">
                        <a data-toggle="tab" href="#tab-eg10-3" class="nav-link letraPequena" id="agregarHorario">Gestión grupal</a>
                    </li>

                    <li class="nav-item">
                        <a data-toggle="tab" href="#tab-eg10-4" estatus="Inactivo" class="nav-link letraPequena" id="btn_filtros">Filtros</a>
                    </li>
...
<script>
    ...
    const obtener_horarios = () => {
        ...
        if ( id_ram.length == 0 ) {
            ...
            $.ajax({
                url: 'server/obtener_horarios2.php',
                type: 'POST',
