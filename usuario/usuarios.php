        ...
        <div class="col-md-12">
            ...
            <div class="card-body">
                ...
                <div class="input-group">
                    ...
                    <select class="browser-default custom-select" id="selector_usuario">
                        ...
                        ?>
                                ...
                                <option value="Admin">Dirección de CDE</option>
                        ...
                        ?>
                                ...
                                <option value="Admin" selected="">Dirección de CDE</option>
                                <option value="Adminge">Coordinador académico</option>
                                <option value="Servicios">Servicios empresariales</option>
                    ...
                    <select class="browser-default custom-select" id="selector_plantel">
                        ...
                        ?>
                                ...
                                <option value="<?php echo $plantel; ?>" selected=""><?php echo $lugar; ?></option>
...
<script>
    $("#titulo_plataforma").html('<?php echo $lugar; ?> - Usuarios');
</script>