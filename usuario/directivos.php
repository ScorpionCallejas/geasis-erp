	...
	<form id="agregarDirectorFormulario" enctype="multipart/form-data" method="POST">
	    <div class="modal-content">
	      ...
	      <div class="modal-footer d-flex justify-content-center">
	        <button class="btn btn-info" type="submit" id="btn_submit">Guardar <i class="fas fa-paper-plane-o ml-1"></i></button>
	      </div>
...
<script>
	...
	$('#agregarDirectorFormulario').on('submit', function(event) {
		...
		$('#btn_submit').attr('disabled','disabled').text('Guardando...');
						...
						$.ajax({
							...
							success: function(respuesta){
								...
								if (respuesta == 'Exito') {
									...
									then((value) => {
										$('#btn_submit').removeAttr('disabled').text('Guardado :)');
