...
<script type="text/javascript">
    ...
    var colHeaders = ['ID', 'NOMBRE', 'FECHA CAP.', 'PERMISOS', 'TELÉFONO', 'CORREO', 'CONTRASEÑA', 'OBSERVACIONES'];
...
<?php
    $sql = "
      SELECT *
      FROM ejecutivo
      WHERE id_pla = '$id_pla' AND eli_eje = 'Activo' AND usu_eje is not null
...
?>
    ...
    hot = new Handsontable(container, {
        ...
        columns: [
            ...
            {
                type: 'dropdown',
                source: ['Servicios', 'Dirección', 'Coordinación']  // Estatus que vi en la imagen
            },
    ...
    function guardarCelda(hot, row, column, value) {
        ...
        if ( id == "" || id == null || id == undefined ) {
            ...
            if(valor){
                ...
                $.ajax({
                    url: 'server/controlador_usuario.php',
                    type: 'POST',
