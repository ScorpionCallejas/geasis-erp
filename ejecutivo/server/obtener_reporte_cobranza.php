	...
	$fin = $_POST['fin'];
 	...
 	if ( $_POST['id_alu_ram'] != '' ) {
 		...
 		$sql = "
			...
			SELECT * 
			FROM vista_pagos
			WHERE id_alu_ram = '$id_alu_ram' AND est_pag = 'Pagado'
	    ...
	    // VISTA COMPLETA
	    	...
	    	$sql = "
		          ...
		          SELECT * 
		          FROM vista_pagos
		          WHERE ( id_pla8 = '$plantel' ) AND ( estatus_general != 'Baja definitiva' AND estatus_general != 'Suspendido' ) AND ( ini_pag BETWEEN '$inicio' AND '$fin' )
		...
		$sub_array[] = '
			<div class="dropdown">
				...
				<a class="btn-link dropdown-toggle" href="#" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-size:10px;">
			  	...
			  	<!--Menu-->
				<div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="font-size:10px; position: relative !important; z-index: 99999;">
					'.$acciones.'
				</div>
