                    ...
                    <tbody style="padding: 0;">
                        ...
                        ?>
                            <tr style="padding: 0;">
                                ...
                                <td style="padding: 0;"><?php echo fechaFormateadaCompacta2($filaPeriodos['ini_per']).' '.fechaFormateadaCompacta2($filaPeriodos['fin_per']); ?></td>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs nav-bordered">
                    <li class="nav-item">
                        <a href="#home-b1" data-bs-toggle="tab" aria-expanded="false" class="nav-link active waves-effect">
                            Home
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="#profile-b1" data-bs-toggle="tab" aria-expanded="true" class="nav-link  waves-effect">
                            Profile
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="#messages-b1" data-bs-toggle="tab" aria-expanded="false" class="nav-link  waves-effect">
                            Messages
                        </a>
                    </li>
                </ul>
