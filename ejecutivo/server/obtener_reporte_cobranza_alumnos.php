...
function obtener_tabla_pagos() {
    ...
    $('#myTable').DataTable({
        ...
        "ajax": {
            url: "server/obtener_reporte_cobranza.php",
            type: "POST",
            data: {
                palabra,
                inicio,
                                                        ...
                                                        if (tip2_abo_pag ==
                                                            ...
                                                            function obtener_seleccion_tipo_condonacion() {
                                                                ...
                                                                if (mon_abo_pag >
                                                                    ...
                                                                    swal("Error en las cantidades",
                                                                            "¡La cantidad NO puede exceder el monto original!",
                                                                            "error", {
                                                                                button: "Aceptar",
                                                                            }
                                                                        )
