            ...
            while ($filaAlumnos = mysqli_fetch_assoc($resultadoAlumnos)) {
                ...
                <tr>
                    ...
                    <td class="letraGrande font-weight-normal">
                        ...
                        ?>
                                <input type="number" class="form-control letraGrande font-weight-normal alumnosCalificados" value="0" min="0" step=".1" max="<?php echo $filaAlumnos['pun_ent']; ?>" id_alu_ram="<?php echo $filaAlumnos['id_alu_ram']; ?>">
                        <?php
                            }else{

                        ?>
                                <input type="number" class="form-control letraGrande font-weight-normal alumnosCalificados" value="<?php echo $filaConsultaCalificacion['pun_cal_act']; ?>" min="0" step=".1" max="<?php echo $filaAlumnos['pun_ent']; ?>" id_alu_ram="<?php echo $filaAlumnos['id_alu_ram']; ?>">
                        <?php
                            }
