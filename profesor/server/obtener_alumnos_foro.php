<?php 
    ...
    $id_sub_hor = $fila['id_sub_hor2'];

?>
<div class="alert alert-warning alert-dismissible fade show font-weight-normal letraGrande font-weight-normal" role="alert">
   
    <strong>NOTA:</strong> 
    <!-- <p class="letraGrande font-weight-normal grey-text "> -->
    ...
    <table class="table table-hover table-sm" id="myTable">
        ...
        <tbody>
            ...
            $sqlAlumnos = "
                ...
                WHERE id_for_cop = '$id_for_cop' AND est_alu_hor = 'Activo'
                ...
                <tr>
                    ...
                    <?php 
                        ...
                        $sqlConsultaCalificacion = "
                            ...
                            WHERE id_alu_ram4 = '$id_alu_ram' AND id_for_cop2 = '$id_for_cop'
                    ...
                    <td class="letraGrande font-weight-normal">
                        ...
                        ?>
                                <input type="number" class="form-control letraGrande font-weight-normal alumnosCalificados" value="0" min="0" step=".1" max="<?php echo $filaAlumnos['pun_for']; ?>" id_alu_ram="<?php echo $filaAlumnos['id_alu_ram']; ?>">
                        <?php
                            }else{

                        ?>
                                <input type="number" class="form-control letraGrande font-weight-normal alumnosCalificados" value="<?php echo $filaConsultaCalificacion['pun_cal_act']; ?>" min="0" step=".1" max="<?php echo $filaAlumnos['pun_for']; ?>" id_alu_ram="<?php echo $filaAlumnos['id_alu_ram']; ?>">
                        <?php
                            }
...
<script>
    ...
    $('.alumnosCalificados').on( 'change', function () {
        ...
        $.ajax({
            ...
            url: 'server/editar_calificacion_foro.php?id_for_cop=<?php echo $id_for_cop; ?>',
            type: 'POST',
