					...
					<div class="row">
	            		...
	            		<div class="col-md-4">
	            			...
	            			<div class="md-form mb-5">
								...
								<input type="text" id="pas_pro" name="pas_pro" class="form-control validate estilo_input" value="<?php echo $contrasenaUsuario; ?>">
								<label class="estilo_input" for="pas_pro">Contraseña</label>
		                    </div>
	            		...
	            		<div class="col-md-4">
	            			...
	            			<div class="md-form mb-5">
								...
								<input type="text" id="tel_pro" name="tel_pro" class="form-control validate estilo_input" value="<?php echo $telefonoUsuario; ?>">
								<label class="estilo_input" for="tel_pro">Teléfono</label>
		                    </div>
	            		...
	            		<div class="col-md-4">
	            			...
	            			<div class="md-form mb-5">
								...
								<input type="text" id="pas_pro" name="dir_pro" class="form-control validate estilo_input" value="<?php echo $direccionUsuario; ?>">
								<label class="estilo_input" for="dir_pro">Dirección</label>
		                    </div>
