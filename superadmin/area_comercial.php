		...
		<div class="card" style="border-radius: 20px;">
			...
			<div class="row p-3">
				...
				<div class="col-md-3">
					...
					<!-- Group of material radios - option 3 -->
					<div class="form-check">
					  <input type="radio" class="form-check-input radioReporte" id="materialGroupExample4" name="seleccionReporte" value="Referidos">
					  <label class="form-check-label letraPequena" for="materialGroupExample4">Referido</label>
					</div>
...
<script>
	...
	function obtener_reporte(){
		...
		} else if ( radioReporte == 'Referidos' ) {
			
			url = 'server/obtener_referidos.php';
