        ...
        <div class="app-main__inner">
            ...
            <nav class="" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="active breadcrumb-item" aria-current="page">Encuestas</li>
                </ol>
            </nav>

            <hr>

            <a href="#" id="btn_agregar_encuesta" class="btn btn-link text-primary">Agregar encuesta</a>
                ...
                <div class="row">
                    ...
                    ?>
                            ...
                            <div class="col-md-4 p-2">
                                ...
                                <div class="border p-2" style="border-radius: 20px; position: relative;">
                                    <i class="fas fa-clipboard-list fa-2x grey-text"></i>
                                
                                        <a href="consulta_encuesta.php?id_enc=<?php echo $fila['id_enc']; ?>" class="btn btn-link letraPequena">
                                    ...
                                    <span class="letraPequena grey-text">
                                        <span class="text-success">Activada:</span> <span id="inicio_encuesta<?php echo $fila['id_enc']; ?>"><?php echo fechaFormateadaCompacta2( $fila['ini_enc'] ); ?></span>
                                        <span class="text-danger">Desactivada:</span>  <span id="fin_encuesta<?php echo $fila['id_enc']; ?>"><?php echo fechaFormateadaCompacta2( $fila['fin_enc'] ); ?></span>
                                    </span>
                                    ...
                                    <a href="#" class="copiarEncuesta grey-text" id_enc="<?php echo $fila['id_enc']; ?>" nom_enc="<?php echo $fila['nom_enc']; ?>" style="position: absolute; top: 10px; right: 40px;" title="Copiar encuesta...">
                                    ...
                                    ?>
                                        ...
                                        <a class="btn btn-sm btn-success switch_encuesta" id_enc="<?php echo $fila['id_enc']; ?>" estatus="<?php echo $fila['est_enc']; ?>" title="Activa/Desactiva la encuesta..." style="position: absolute; bottom: 10px; right: 20px;">
                                            Activada
                                        </a>
                                    ...
                                    ?>
                                            ...
                                            <a class="btn btn-sm btn-danger switch_encuesta" id_enc="<?php echo $fila['id_enc']; ?>" estatus="<?php echo $fila['est_enc']; ?>" title="Activa/Desactiva la encuesta..." style="position: absolute; bottom: 10px; right: 20px;">
                                                Desactivada
                                            </a>
            ...
            $.ajax({
                ...
                success: function ( respuesta ) {
                    ...
                    if ( estatus == 'Activo' ) {
                        ...
                        elemento.removeClass('btn-success').addClass('btn-danger').removeAttr('estatus').attr( 'estatus', 'Inactivo' ).text('Desactivada');;
                        ...
                        elemento.removeClass('btn-danger').addClass('btn-success').removeAttr('estatus').attr( 'estatus', 'Activo' ).text('Activada');
