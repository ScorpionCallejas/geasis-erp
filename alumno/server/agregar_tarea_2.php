<?php 
	...
	if ($resultado) {
		...
		$materia = str_replace(' ','',$filaDatosActividad['nom_mat']);
		$bloque = str_replace(' ','',$filaDatosActividad['nom_blo']);
		$entregable = str_replace(' ','',$filaDatosActividad['nom_ent']);
		$grupo = str_replace(' ','',$filaDatosActividad['nom_gru']);
		$alumno = str_replace(' ','',$nombreCompleto);
		...
		$tarea = $grupo."_".$alumno."_".$entregable."_".$bloque."_".$materia."_".$tareaMax;
