...
?>
    ...
    <div class="jumbotron mx-2 mb-5 text-center" style="border-radius: 20px;" data-step="9" data-intro="La tarea su sube aquí, solo un archivo, el sistema acepta diversos formatos como imágenes (jpg, jpeg o png), word, pdf, excel, power point... ¡entre muchos más!" data-position='right'>
		...
		<p class="note note-info">
			...
			La tarea se sube aquí, SOLO UN ARCHIVO, la plataforma acepta diversos formatos como imágenes (jpg, jpeg o png), word, pdf, excel y power point. No canceles mientras se sube el archivo.
