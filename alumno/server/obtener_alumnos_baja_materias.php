...
<div class="row">
	...
	<div class="col-md-10">
		...
		?>
				<div class="chip animated fadeInDown delay-1s seleccionAlumnoFinal" id_alu_ram="<?php echo $filaAlumno['id_alu_ram']; ?>" title="Dar de baja horario a <?php echo $alumno; ?> del programa <?php echo $programa; ?>">
