							...
							?>
									<li class="p-2 elementos white lighten-3">
			                          <a class="d-flex  text-left" href="#">
			                          	<?php 
			                          		if ($filaCompaneros['foto'] == "" ) {
			                          	?>
												<img src="../img/usuario.jpg" class="avatar rounded-circle d-flex align-self-center mr-1 z-depth-1" width="70px" height="80px">
	  ...
	  <div class="modal-content">
	    ...
	    <div class="modal-body text-center mb-1">
				...
				<div class="md-form" id="divMsj">
		          ...
		          <label data-error="wrong" data-success="right" for="msjContacto">Escribe un mensaje...</label>
		        </div>
  	...
  	$('.usuarios').on('click', function(event){
  		...
  		$.ajax({
              ...
              if ( datosUsuario.foto == null ) {
              	$('#fotoContacto').attr({src: "../img/usuario.jpg"});
