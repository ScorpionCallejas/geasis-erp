<?php 
  ...
  $sqlSalas = "
    ...
    INNER JOIN mensaje ON sala.id_sal = mensaje.id_sal4
...
?>
    ...
    <div class="chat-list-item d-flex flex-row w-100 p-2 border-bottom unread seleccionSala" id_sal="<?php echo $id_sal6; ?>" sala_nombre="<?php echo $sala_nombre; ?>" sala_foto="<?php echo obtenerValidacionFotoUsuario( $sala_foto ); ?>" receptor = " <?php echo $use_not_men; ?> ">
