...
<form class="calc" id="calculadora" style="display: none;">
	<p class="calc-display">
	  <input type="text" name="res" id="res" class="calc-display-input" onfocus="this.blur()" >
	</p>
	<p class="calc-row">
	  <button type="button" class="calc-button calc-button-gray" id="btn_calculadora_cerrar" style="background: red;"><span style="font-size: 10px;"><i class="fas fa-power-off fa-1x"></i></button>
	  <button type="button" class="calc-button calc-button-gray" onclick="s('Sistema....')">mrc</button>
	  <button type="button" class="calc-button calc-button-gray" onclick="s('....GEA..')">m-</button>
