...
<body>
	...
	<div class="container-fluid" id="main-container">
		...
		<!-- REDIRECCION A LEGACY -->
		<a href="mensajes.php"><i class="fas fa-arrow-left"></i> Ir a mensajería pasada (esta mensajería comenzará a operar íntegramente dentro de <?php echo obtenerDiferenciaFechas( '2022-05-31', date('Y-m-d') ); ?> días )</a>
		<!-- REDIRECCION A LEGACY -->
				...
				<div class="row d-flex flex-row align-items-center p-2 m-0 w-100" id="navbar">
					...
					<div class="d-flex flex-row align-items-center ml-auto">
						...
						<?php  
							if ( $tipo != 'Alumno' ) {
						?>
								<a href="#" id="btn_eliminacion_sala" title="Elimina esta sala de mensajería"><i class="fas fa-trash-alt mx-3 text-white d-md-block"></i></a>
 ...
 -->
	...
	<script>
		...
		obtener_contactos_mensajeria();
		function obtener_contactos_mensajeria(){
